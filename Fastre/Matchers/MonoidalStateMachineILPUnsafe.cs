...
namespace Fastre
{
    public sealed class MonoidalStateMachineILPUnsafe : IMatcher<byte>
    {
        ...
        public unsafe MonoidalStateMachineILPUnsafe(sbyte start, Func<byte, sbyte, sbyte> transitionFunc, in ReadOnlySpan<sbyte> accept)
        {
            _start = start;
